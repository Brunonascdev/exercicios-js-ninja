(function () {
    ...
    */
    let arr01 = ['teste', 2, true, null, Infinity];
    ...
    */
    ...
    console.log(brasil = brasil.concat('Amazonas', 'Pará', 'Tocantins', sul, sudeste));
    ...
    */
    let nordeste = ['Paraíba', 'Maranhão', 'Alagoas'];
    ...
    */
    ...
    chamada `newSudeste`.
    */
    let newSudeste = brasil.splice(5, 9);
    ...
    */
    ...
    brasil.every(function (item) {
        item.length > 7 ? frase = "Sim, todos os estados tem mais de 7 letras!" : frase = "Nem todos os estados tem mais de 7 letras!";
    });
    console.log(frase);
    /*
    ...
    */
    ...
    var fraseDois = '';
    brasil.forEach(function (item) {
        if (item === "Ceará") { fraseDois = "Ceará está incluído!" } else { fraseDois = "Ceará não foi incluído :(" }
    });
